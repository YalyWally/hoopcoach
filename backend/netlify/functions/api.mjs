...
// (/.netlify/functions/api/...) — basePath below strips that prefix back
// off so the Express app sees the same paths it expects locally (e.g.
// /players/:id), matching how server.js mounts it at /api for local dev.
//
